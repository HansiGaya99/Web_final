...
<body class='body' >
  <!--Navigation Bar-->
    ...
    <div id='pool' class='pback container-fuild' style='background-image: url(../resourses/help.jpg); background-size: cover; width: 100%; padding: 50px; background-attachment: fixed;'>
        ...
        <div id='about' class='container' style='background-color: rgba(12, 8, 0, 0.486); padding: 70px; border-radius: 10px;color: white;text-align:center;'>
        ...
        <br><h3 style='color: white;'>Login Details</h3><br>            
              ...
              <h2 class='mx-auto' style='color: white;width: 50%; text-align: center;opacity: 0.6;'>Oops .. ! You Haven't Any Reservation..</h2>
                    <p class='mx-auto' style='color: white;width: 50%; text-align: center;opacity: 0.6;'>Make A Reservation & Enjoy Unforgettable Experiences</p></div>        
    </div>";
